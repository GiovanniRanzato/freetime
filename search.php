...
<?php } else {  ?>
    <?php echo get_template_part("template-parts/hero-section"); ?>
    <main class="cs-main">
        <div class="container cs-main-container" style="max-width:800px">
            <div class="p-0">
                <div class="row">
                    <div class="cs-article-card">
                        <div class="cs-card">
                            <div class="cs-card-body">
                                <p>Attenzione non è stato trovato alcun risultato per la query inserita!<br>Prova un'altra ricerca:</p>
